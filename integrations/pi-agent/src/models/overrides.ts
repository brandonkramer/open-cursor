...
export type ModelOverride = Pick<
  Model<Api>,
  "reasoning" | "input" | "cost" | "contextWindow" | "maxTokens"
>;

export const findModelOverride = (id: string): ModelOverride => {
...
const overrides = [
  ...
  },
  {
    ...
    reasoning: true,
    input: ["text", "image"],
    cost: { input: 10, output: 60, cacheRead: 1.0, cacheWrite: 0 },
    contextWindow: 272000,
    maxTokens: 128000,
  },
  {
  ...
  },
  {
    ...
    reasoning: true,
    input: ["text", "image"],
    cost: { input: 7, output: 35, cacheRead: 0.7, cacheWrite: 0 },
    contextWindow: 272000,
    maxTokens: 128000,
  },
  {
...
] satisfies (ModelOverride & { id: RegExp })[];
