import {
  ...
  KvClientMessage,
  SetBlobResult,
} from "@open-cursor/protocol/__generated__/agent/v1/kv_pb.js";
import type {
  KvClientMessage as KvClientMessageType,
  KvServerMessage,
} from "@open-cursor/protocol/__generated__/agent/v1/kv_pb.js";
...
export interface BlobStore {
  ...
  setBlob(ctx: unknown, blobId: Uint8Array, blobData: Uint8Array): Promise<void>;
}
...
export class KvManager {
  ...
  private readonly clientStream: Writable<KvClientMessageType>;
  private readonly blobStore: BlobStore;

  constructor(
    serverStream: AsyncIterable<KvServerMessage>,
    clientStream: Writable<KvClientMessageType>,
    blobStore: BlobStore,
  ) {
                ...
                new KvClientMessage({
                  ...
                  message: {
                    ...
                    value: new GetBlobResult({
                      blobData: response ? toUint8Array(response) : new Uint8Array(),
                    }),
                  },
                }),
              );
